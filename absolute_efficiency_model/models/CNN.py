...
class PredictionCNN(nn.Module):
    def __init__(self, k, input_dim, dictionary = 4, mlp_embedder_config=None):
        super().__init__()
        ...
        self.fc1 = nn.Linear(in_features=128 * last_conv, out_features=64)
        ...
        self.Wy = nn.Linear(self.lastlayer_inputdim, 2, bias=True)
    ...
    def forward(self, x_proto, x_feat=None):
        ...
        x = x_proto.reshape(x_proto.shape[0], self.input_dim, 4) 
